...
function FeatureBlock({title, Icon, description, href}){
    return(            
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 my-7">
            ...
            <div className="flex flex-col items-center pb-10">
                ...
                <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-dark">{title}</h5>
                ...
                <div className="flex mt-4 space-x-3 md:mt-6">
                    <a href={href} className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get Started</a>
                </div>
            </div>
        </div>
