...
function NavBar(){
    ...
    const [loggedIn, setAuth] = useState(isAuthenticated);
    return(
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <a className="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-white lg:items-center lg:justify-center mb-4 md:mb-0">
      {
            isAuthenticated ? <img src={user.picture} alt={user.name} className="w-10 h-10 rounded-full"/> : <svg fill="#ffffff" height="50px" width="50px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
